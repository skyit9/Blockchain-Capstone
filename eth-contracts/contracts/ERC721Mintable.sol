...
contract Ownable {
    ...
    modifier onlyNotOwner(address _address) {
        require(_owner != _address, "Only Not Owner");
        _;
    }
...
//    @dev Approves another address to transfer the given token ID
    function approve(address to, uint256 tokenId) public {
        ...
        require(owner != to, "Owner can't approve yourself");
        
        // TODO require the msg sender to be the owner of the contract or isApprovedForAll() to be true
        require(_tokenOwner[tokenId] != msg.sender, "Sender needs to be the owner");
    ...
    // TIP: remember the functions to use for Counters. you can refresh yourself with the link above
    function _mint(address to, uint256 tokenId) internal onlyValidAddress(to) {
    ...
    // TIP: remember the functions to use for Counters. you can refresh yourself with the link above
    function _transferFrom(address from, address to, uint256 tokenId) internal onlyValidAddress(_tokenOwner[tokenId]) onlyValidAddress(to) {
...
contract SkyERC721Token is ERC721Metadata {
